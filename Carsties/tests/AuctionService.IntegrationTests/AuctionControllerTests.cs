...
public class AuctionControllerTests : IAsyncLifetime
{
    ...
    private const string _gT_ID = "afbee524-5972-4075-8800-7d1f9d7b0a0c"; // car id from mock db
    ...
    // this is going to initialize before every test in this class
    public Task InitializeAsync() => Task.CompletedTask;

    // this is going to activate after every single test in this class
    ...
    public async Task CreateAuction_WithAuth_ShouldReturn201()
    {
        ...
        // act
        var getResponse = await _httpClient.GetFromJsonAsync<AuctionDto>($"api/auctions/{createdAuction.Id}");
        // assert
        Assert.Equal(auction.Make, getResponse.Make);
    }
