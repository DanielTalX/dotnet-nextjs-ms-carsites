...
public class DbInitializer
{
    ...
    {
        /*"using" keyword here because this will allow the framework once we're finished with this method
        to dispose of any of the services we've used inside this scope that we're creating*/
